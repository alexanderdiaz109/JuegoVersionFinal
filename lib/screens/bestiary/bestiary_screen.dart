...
class BestiaryScreen extends StatelessWidget {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          // --- CAMBIO AQUÍ: TÍTULO DE TEXTO MEDIEVAL ---
          title: const Text(
            "BESTIARIO",
            style: TextStyle(
              fontFamily: 'Medieval', 
          ...
          bottom: TabBar(
            ...
            // Estilos de texto para las pestañas
            labelStyle: const TextStyle(fontFamily: 'Medieval', fontSize: 18, fontWeight: FontWeight.bold),
            unselectedLabelStyle: const TextStyle(fontFamily: 'Medieval', fontSize: 16),
  ...
  Widget _buildTabWithBackground(BuildContext context, List<BestiaryItem> items, String imagePath) {
    return Container(
      ...
      child: Padding(
        padding: EdgeInsets.only(top: MediaQuery.of(context).padding.top + 160), 
    ...
    if (items.isEmpty) {
      return const Center(
        child: Text(
          ...
          style: TextStyle(color: Colors.white70, fontFamily: 'Medieval', fontSize: 24)
        )
      );
    }
